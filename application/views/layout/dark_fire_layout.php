<?php if($this->user->loggedin==false) {
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <?php if(!empty($gl)) :?>
                    <div class="row">
                        <div class="col-md-12">
<div class="alert alert-success" role="alert"><div class="row vertical-align" style="display: flex; align-items: center"><div class="col-md-1 text-right"><span class="glyphicon glyphicon-ok"></span></div><div class="col-xs-11"><b><h5><?php echo $this->session->flashdata('globalmsg') ?></h5></b></div></div></div>                        </div>
                    </div>
        <?php endif; ?>
