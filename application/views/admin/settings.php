...
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_458") ?></label>
    <div class="col-sm-10">
        <select name="logo_option" class="form-control">
        <option value="0"><?php echo lang("ctn_459") ?></option>
        <option value="1" <?php if($this->settings->info->logo_option == 1) echo "selected" ?>><?php echo lang("ctn_460") ?></option>
        </select>
        <span class="help-block"><?php echo lang("ctn_461") ?></span>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="se-in" class="col-sm-2 control-label"><?php echo lang("ctn_462") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_463") ?></label>
    <div class="col-sm-10">
        ...
        <span class="help-block"><?php echo lang("ctn_464") ?></span>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_465") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="google_recaptcha" value="1" <?php if($this->settings->info->google_recaptcha) echo "checked" ?> />
        <span class="help-block"><?php echo lang("ctn_466") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_467") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_468") ?></label>
    <div class="col-sm-10">
...
<!--
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_442") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <span class="help-block"><?php echo lang("ctn_445") ?></span>
    </div>
</div>
