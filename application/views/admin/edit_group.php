...
<strong><a id="cookiesBtn" name="cookiesBtn" href="<?php echo site_url("polls/create?saved=".$form); ?>"><?php echo lang("ctn_576") ?></a></strong>
</div>
<?php 
endif; 
}
?>
<?php echo form_open(site_url("admin/edit_group_pro/" . $group->ID."/?saved=".$form), array("class" => "form-horizontal")) ?>
